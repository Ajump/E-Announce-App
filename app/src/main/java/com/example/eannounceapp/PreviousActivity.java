...
public class PreviousActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        eventSearchList = (ArrayList<EventsDetails>) getIntent().getSerializableExtra("eventListforPrevious");
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            case R.id.menu_search:
                Intent searchActivity = new Intent(PreviousActivity.this, SearchActivity.class);
                searchActivity.putExtra("eventList",eventSearchList);//Pass ArrayList to Search Activity
                startActivity(searchActivity);
                return true;
            case R.id.menu_logout:
                FirebaseAuth.getInstance().signOut();
                Intent intentLogout = new Intent(PreviousActivity.this, Login.class);
